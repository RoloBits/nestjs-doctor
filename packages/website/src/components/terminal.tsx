...
const PROJECT_SCAN_DELAY_MS = 500;
const POST_HEADER_DELAY_MS = 350;
const DIAGNOSTIC_MIN_DELAY_MS = 80;
const DIAGNOSTIC_MAX_DELAY_MS = 200;
const SCORE_REVEAL_DELAY_MS = 400;
const SCORE_FRAME_COUNT = 20;
const SCORE_FRAME_DELAY_MS = 25;
const POST_SCORE_DELAY_MS = 500;
...
const CLAUDE_PROMPT_DELAY_MS = 700;
const CLAUDE_YES_DELAY_MS = 500;
const CLAUDE_POST_YES_DELAY_MS = 500;
const SKILL_FIX_MIN_DELAY_MS = 60;
const SKILL_FIX_MAX_DELAY_MS = 140;
const SKILL_POST_FIX_DELAY_MS = 400;
