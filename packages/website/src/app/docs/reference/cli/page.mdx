...
link, and then a bad and a good sample of the pattern. Every sample is tested
against the rule it illustrates, so the bad one is what the rule reports and
