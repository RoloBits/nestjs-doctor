...
No config file, nothing to set up. It reads your TypeScript, runs 50 rules, and
...
`npx` is enough for a one-off. Install it to pin one version for everyone, or to
use the VS Code extension, which loads nestjs-doctor from your workspace.
