...
The generated report includes four tabs:

- **Summary** — health score overview with category breakdown
- **Diagnosis** — source-level findings with code viewer and fix examples
- **Modules Graph** — physics-based layout with draggable nodes, directed edges, color coding for root modules and circular dependencies, detail panel with auto-focus, and concrete fix suggestions
