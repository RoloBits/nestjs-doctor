...
- If a rule can't find expected AST nodes, the file might not have been added to the project. Check the [file collection](/docs/pipeline/file-collection) step.
