...
The report includes five tabs:

- **Summary** — health score overview with category breakdown
- **Diagnosis** — source-level findings with code viewer and fix examples
- **Modules Graph** — directed graph layout with draggable nodes, directed edges, color coding, detail panel with auto-focus, and circular dependency recommendations
