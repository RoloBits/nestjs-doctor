...
3 rules that validate your database schema design — primary keys, timestamps, and relation configuration. These rules run against entity-relation data extracted from Prisma schema files, TypeORM/MikroORM entity decorators, or Drizzle table declarations.
