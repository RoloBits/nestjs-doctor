...
**Note:** The rule skips infrastructure classes: guards, interceptors, filters, pipes, middleware, strategies, subscribers, listeners, processors, consumers, workers, schedulers, and health indicators.
