...
**Why:** Dynamic requires prevent bundlers from analyzing dependencies, can load unexpected modules, and are a potential security risk if the argument comes from user input.
...
**Why:** Unused providers are dead code. They increase module initialization time, add confusion, and should be removed.
...
**Why:** Unused exports suggest the module boundary isn't being used as intended. Either the export is dead code or the consuming module is missing the import.
