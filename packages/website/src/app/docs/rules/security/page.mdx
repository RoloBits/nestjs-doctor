...
Scanning a subdirectory is the exception. The rule walks up to the nearest `package.json`, and a finding above the scanned directory is always kept. The changed-file set only describes the tree below it.
