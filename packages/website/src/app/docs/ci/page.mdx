...
- [Failing the build](/docs/ci/gates) — gate a pull request on the findings or the score
- [Other CI providers](/docs/ci/other-providers) — GitLab, SARIF, markdown, pre-commit
