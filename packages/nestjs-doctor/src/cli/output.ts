...
/**
 * Applies both gates and exits when either fails.
 *
 * `--min-score` and `--blocking` are independent: a project can sit above its
 * score threshold and still introduce an error that should not merge.
 */
