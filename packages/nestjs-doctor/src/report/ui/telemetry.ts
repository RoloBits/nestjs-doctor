...
(function () {
  ...
  var ACTIONS = ["rule_lab_run", "rule_lab_preset_loaded", "rule_lab_scope_changed", "rule_lab_result_opened", "module_opened_from_finding", "graph_recentered", "graph_zoomed", "graph_sidebar_toggled", "module_tree_expanded", "schema_tree_expanded", "endpoint_code_opened", "boot_trace_opened"];
  var id;
  try {
